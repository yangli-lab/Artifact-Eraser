...
"""
implementation of paper Single-Image Noise Level Estimation for Blind Denoising
"""
...
pathI="./noise_eval/lena.png"

image = cv2.imread(pathI)
only_one = image[:256, :, :]
grayImage = cv2.cvtColor(only_one, cv2.COLOR_BGR2GRAY)
